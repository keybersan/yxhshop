package com.rkele.yxhshop.gateway.contant;


import com.rkele.yxhshop.gateway.utils.ResultStatus;

public enum YxhshopWechatResultStatus implements ResultStatus {
    ...
    YxhshopWechatResultStatus(String code, String msg) {
        this.code = code;
        this.msg = msg;
    }
