...
import com.rkele.yxhshop.order.fallback.WxPayApiFallback;
...
@FeignClient(value = "yxhshop-pay", path = "pay", fallback =WxPayApiFallback.class)
public interface WxPayApi {
  ...
  Result<WxPayOrderQueryResult> queryOrder(@RequestParam(value = "transactionId", required = false) String transactionId,
  ...
  Result<WxPayOrderCloseResult> closeOrder(@PathVariable("outTradeNo") String outTradeNo);
  ...
  Result<WxPayRefundQueryResult> refundQuery(@RequestParam(value = "transactionId", required = false) String transactionId,
                                             @RequestParam(value = "outTradeNo", required = false) String outTradeNo,
  ...
  Result<WxPayRedpackQueryResult> queryRedpack(@PathVariable("mchBillNo") String mchBillNo);
  ...
  Result<WxPayBillResult> downloadBill(@PathVariable("billDate") String billDate, @PathVariable("billType") String billType,
                                       @PathVariable("tarType") String tarType, @PathVariable("deviceInfo") String deviceInfo);
